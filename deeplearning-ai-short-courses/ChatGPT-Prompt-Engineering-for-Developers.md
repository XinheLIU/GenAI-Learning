...
- [ChatGPT Prompt Engineering for Developers](#chatgpt-prompt-engineering-for-developers)
  ...
  - [Tasks Example](#tasks-example)
    ...
    - [Infering](#infering)
      ...
      - [Transform (Text \& Data)](#transform-text--data)
      - [Expand](#expand)
...
- Limit, specify output format, length, other requirements
- Guide to focus on different details

![](2023-06-09-14-56-33.png)
